...
def test_pi_omega_L_matches_brute_force_and_couples_events():
    ...
    for L, M in [(2, 6), (3, 7), (4, 9)]:
        ...
        scores = crit._hypothesis_log_scores(crit._class_log_posterior(matched))
        ...
        moved = crit._hypothesis_log_scores(crit._class_log_posterior(perturbed))
...
def test_degenerate_meter_falls_back_to_the_marginal():
    ...
    assert crit._hypothesis_log_scores(crit._class_log_posterior(matched)) is None, (
